...
namespace Core::Graphics
{
    ...
    public:
        ...
        virtual const IShaderPipeline* AllocateShaderPipeline(const ShaderPipelineDesc* desc) pure;
        virtual const IShaderArguments* AllocateShaderArguments(const IShaderPipeline* pipeline) pure;

    public:
        virtual Void RecCreateTexture(const ExecutionContext& context, const ITexture* texture) pure;

        virtual Void RecCreateFilter(const ExecutionContext& context, const IFilter* filter) pure;

        virtual Void RecCreateRenderPass(const ExecutionContext& context, const IRenderPass* target) pure;
        ...
        virtual Void RecCreateShaderPipeline(const ExecutionContext& context, const IShaderPipeline* target) pure;
        virtual Void RecCreateShaderArguments(const ExecutionContext& context, const IShaderArguments* target) pure;
        ...
        virtual Void RecCreateBuffer(const ExecutionContext& context, const IBuffer* target) pure;
        ...
        virtual Void RecCreateSwapChain(const ExecutionContext& context, const ISwapChain* target) pure;
